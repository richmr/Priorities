...
function getPriorityTableProjects_test() {
	var chips = { "priority-chip1": { "projectID":"1", "blank":"0"},
...
function getArchivedProjects_test() {
	var projs = ["15", "20"];
	return projs;
} 

function getProjectBasics_test() {
	var projs = { "0": {"title":" ", "status":"chip-placeholder", "draggable":false, "droppable":true, "click":"none"},
